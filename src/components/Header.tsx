  ...
  return (
    <header className="fixed top-0 left-0 right-0 bg-[#0C1943] backdrop-blur-md border-b border-[#CAA53E]/20 z-50 shadow-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {isMenuOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-[#0C1943] border-t border-[#CAA53E]/20">
              <button
                onClick={() => scrollToSection('accueil')}
                className="block w-full text-left px-3 py-2 text-white hover:text-[#CAA53E] hover:bg-[#CAA53E]/20 transition-colors rounded-lg bg-transparent border-none outline-none"
              >
                Accueil
              </button>
              <button
              ...
              <div className="flex flex-col space-y-2 px-3 pt-4">
                <Button variant="outline" className="w-full text-white hover:text-[#CAA53E] hover:bg-[#CAA53E]/20 !bg-transparent border-[#CAA53E]/30">
                  Se connecter
                </Button>
